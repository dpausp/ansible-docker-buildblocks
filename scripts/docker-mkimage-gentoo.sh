...
# modifications for ansible gentoo bootstrap (c) 2015 Tobias 'dpausp'
#
...
# exit ${?} in previous version returned 1 for successful imports. Why?
# TODO: debug this! ;)
exit $RET
